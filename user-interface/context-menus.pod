...
menu for a folder.
 ...
 .--------------------------.   .----------------------------------.
 | Open in new tab          |   | Open all (n)                     |
 | Open in new window       |   | Open all (n) in new window       |
 | Open in Incognito window |   | Open all (n) in Incognito window |
 | Open in split view       |   | Open all (n) in new tab group    |
 |--------------------------|   |----------------------------------|
 | Edit...                  |   | Rename...                        |
 |--------------------------|   |----------------------------------|
 | Cut                      |   | Cut                              |
...
Observe that the menus have an unequal number of items. (This is no longer true
after a recent update.) Common items are indexed parallelly from the bottom
upwards.  The first eleven items from the bottom are common to both menus.
Programmatic access of these items could be achieved by moving up the menu from
the bottom.  One could define a function called C<SelectNthFromBottom(Index)>.
...
Last updated on Sunday, December 7th, 2025 at 2:52 AM.
