...
knowledge about the item from which the context menu was spawned.
...
=item An opening and closing pair of square brackets denotes that the menu item
is checkable.
...
An exception is the C<edit> and C<rename> items.  In other browsers, these are
named "Edit bookmark" and "Edit folder".  Thereon, they encompass the same basic
...
Last updated on Saturday, October 4th, 2025 at 3:14 PM.
