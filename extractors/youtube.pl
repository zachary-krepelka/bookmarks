...
# UPDATED: Thursday, April 16th, 2026 at 9:58 PM
...
make_folder 2, "Posts", [sort {compare($a, $b)} @posts] if @posts;
...
This folder contains bookmarked YouTube posts.  These are bookmarks with
URLs of the form

	youtube.com/post/{POST_ID}
